...
class CreateUserSchema(BaseUserSchema):
    ...
    client_salt: str = Field(
        min_length=6,
        max_length=64,
        description="Client salt. Password is hashed with this salt before sent to server.\
            Salt is generated by the client or requested from the server at `/get_salt`.",
    )
